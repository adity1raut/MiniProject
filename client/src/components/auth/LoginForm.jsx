...
import { MessageSquare, Video, Users, Sparkles, Github, Mail, Lock } from 'lucide-react';
        ...
        <div className={`hidden lg:flex lg:flex-1 flex-col ${isDark ? 'text-white' : 'text-white'} space-y-8`}>
          <div className="space-y-4">
            ...
            <h1 className="text-5xl font-bold leading-tight">
              ...
              <span className={`${isDark ? 'text-purple-300' : 'text-blue-100'}`}>Communicate</span>
            </h1>
            <p className={`text-lg ${isDark ? 'text-gray-300' : 'text-blue-50'}`}>
              Experience the future of messaging with AI-powered conversations, crystal-clear video calls, and seamless group collaboration.
            </p>
          </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center justify-between text-xs sm:text-sm">
                <label className="flex items-center cursor-pointer">
                  <input type="checkbox" className="mr-1.5 sm:mr-2 rounded w-3.5 h-3.5 sm:w-4 sm:h-4" />
                  <span className={isDark ? 'text-gray-300' : 'text-gray-600'}>Remember me</span>
                </label>
                <button type="button" className={`${isDark ? 'text-purple-400 hover:text-purple-300' : 'text-purple-600 hover:text-purple-700'} font-medium`}>
                  Forgot?
                </button>
              </div>
